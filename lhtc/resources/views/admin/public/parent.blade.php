...
<body data-type="index">
    ...
    <div class="am-g tpl-g">
                ...
                <div class="am-fr tpl-header-navbar">
                    <ul>
                        ...
                        <li class="am-text-sm tpl-header-navbar-welcome">
                            <a href="javascript:;">欢迎您, <span>大佬,给您递茶！</span> </a>
                        </li>
        ...
        <div class="left-sidebar">
            ...
            <ul class="sidebar-nav">
                <li class="sidebar-nav-heading">祥云微博 <span class="sidebar-nav-heading-info"> 分类</span></li>
                ...
                <li class="sidebar-nav-link">
                    <a href="javascript:;" class="sidebar-nav-sub-title">
                        <i class="am-icon-table sidebar-nav-link-logo"></i> 微博模块
                        <span class="am-icon-chevron-down am-fr am-margin-right-sm sidebar-nav-sub-ico"></span>
                    </a>
                    <ul class="sidebar-nav sidebar-nav-sub">
                        <li class="sidebar-nav-link">
                        ...
                        <li class="sidebar-nav-link">
                            <a href="{{ url('admin/users') }}">
                                <span class="am-icon-angle-right sidebar-nav-link-logo"></span> 回复列表
                            </a>
                        </li>
                        <li class="sidebar-nav-link">
                            <a href="{{ url('admin/wb_relay') }}">
                                <span class="am-icon-angle-right sidebar-nav-link-logo"></span> 转发列表
                            </a>
                        </li>
                    </ul>
                </li>
    ...
    <script>
            function doWbDel(wb_id)
            {
                if(confirm('你确定要删除吗？')){
                    var form = document.myform;
                    form.action = 'wb_relay/'+wb_id;
                    form.submit();
                }       
            }
    </script>
